...
export interface RenderedBranch {
  ...
  isPruned: boolean;
  isTerminal: boolean;
  /** Centre of the spur pad generated by `terminalFoliage` along this
   *  branch's length, if one was rolled for this branch/day. Used as an
   *  additional flower site (real spur-shoot blossoms on cherry, catkins on
   *  oak) beyond terminal tips. Absent when no spur pad was generated. */
